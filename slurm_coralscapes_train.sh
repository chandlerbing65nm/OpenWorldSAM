...
#SBATCH --output=logs/a-coralscapes/output_%j.txt
...
OUTPUT_DIR=${OUTPUT_DIR:-./output_coralscapes_semseg}
RUN_IDX=${RUN_IDX:-0}
...
# ---------------------------------------------------------------------------
# Data loading / Coralscapes semantic segmentation dataset
# ---------------------------------------------------------------------------
NUM_WORKERS=${NUM_WORKERS:-4}
RANDOM_SUBSET_RATIO=${RANDOM_SUBSET_RATIO:-1.0}
IMAGE_SIZE=${IMAGE_SIZE:-1024}
CORALSCAPES_DATASET_ROOT=${CORALSCAPES_DATASET_ROOT:-/scratch/project_465002853/datasets/coralscapes/Coralscapes}
CORALSCAPES_NUM_CLASSES=${CORALSCAPES_NUM_CLASSES:-39}
...
# ---------------------------------------------------------------------------
# Semantic post-processing thresholds for training-time eval
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
TRAIN_VISUAL_ENCODER=${TRAIN_VISUAL_ENCODER:-False}
...
NUM_OBJECT_QUERIES=${NUM_OBJECT_QUERIES:-10}
...
export CORALSCAPES_DATASET_ROOT
...
if [ "$RUN_MODE" = "train" ]; then
  python train_net.py \
    ...
    DATASETS.TRAIN "('coralscapes_sem_seg_train',)" \
    DATASETS.TEST "('coralscapes_sem_seg_val',)" \
    ...
    MODEL.SEM_SEG_HEAD.NUM_CLASSES "$CORALSCAPES_NUM_CLASSES" \
