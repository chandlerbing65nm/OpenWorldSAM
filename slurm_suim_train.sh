...
OUTPUT_DIR=${OUTPUT_DIR:-./output_suim_semseg}
RUN_IDX=${RUN_IDX:-0}
...
# ---------------------------------------------------------------------------
# Data loading / SUIM semantic segmentation dataset
# ---------------------------------------------------------------------------
NUM_WORKERS=${NUM_WORKERS:-4}
RANDOM_SUBSET_RATIO=${RANDOM_SUBSET_RATIO:-1.0}
IMAGE_SIZE=${IMAGE_SIZE:-1024}
SUIM_DATASET_ROOT=${SUIM_DATASET_ROOT:-/scratch/project_465002853/datasets/suim/SUIM}
